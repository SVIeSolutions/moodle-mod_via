<?php 
//
// Capability definitions for the via module.
//
...
$capabilities = array(
    ...
    // Ability to see that the vialive exists, and the basic information
    // about it.
	'mod/via:addinstance' => array(
