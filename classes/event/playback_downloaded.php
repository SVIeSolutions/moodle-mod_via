...
class playback_downloaded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('playback_downloaded', 'via');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' downloaded a recording for the via activity
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, "via", get_string('playback_downloaded', 'via'),
