...
$string['configassist'] = 'Click here for the setup wizard';
$string['technicalassist'] = 'Click here to get technical support ';
$string['manageparticipants'] = 'Manage participants list.';
...
$string['activitydone'] = 'This activity is done.';
...
$string['repetition'] = 'Repeat session';
$string['repetitionweek'] = 'Weekly';
$string['repetitionmonth'] = 'Monthly';
$string['every'] = 'Every';
$string['everymonth'] = 'Once a month, on';
$string['endrepetition'] = 'Frequency ending';
$string['sequence'] = 'Add number to activities';
...
$string['sendinvitenow'] = 'Send invitations to all participants.';
...
$string['moodle_adminid'] = 'API configuration - Step 2';
...
$string['alert'] = 'Alerts';
$string['overflowalert'] = 'Alert if overflow';
$string['overflowalertdesc'] = 'Send an email alert if there is an overflow of participants.';
$string['preventoverflowalert'] = 'Alert if near overflow';
$string['preventoverflowalertdesc'] = 'Send an email alert if we are near an overflow of participants.';
$string['preventoverflownbr'] = 'Seats left before alert';
$string['preventoverflownbrdesc'] = 'Send an email alert if there is only this number of seats left before an overflow of participants.';
...
$string['testconnection'] = 'Test API connection with these informations';
...
$string['via:manage'] = 'Manage Via';
$string['via:manageparticipants'] = 'Manage Via Participants';
$string['via:view'] = 'See Via';
$string['via:viewparticipants'] = 'View Via Participants';
$string['via:viewrecordings'] = 'View Via Recordings';
$string['via:viewactivities'] = 'View Via Activities';
...
$string['overflowalertemailsubject'] = 'There is a risk of overflow on Via';
$string['overflowalertemail'] = 'There is a risk of overflow on Via. $a->seatstaken seats are taken on a total of $a->totalseats';
$string['overflowemailsubject'] = 'There is an overflow on Via';
$string['overflowemail'] = 'There is an overflow on Via right now. All seats are taken.';
...
$string['error:CANNOT_CHANGE_STATE'] = 'CANNOT_CHANGE_STATE - L\'activit&eacute; ne peut changer d\'&eacute;tât.';
$string['error:CIEID_NOT_FOUND'] = 'CIEID_NOT_FOUND - CieID doesn\'t exists. Please verify your settings.';
...
$string['error:STATUS_INVALID']= ' - La connexion &agrave; la salle de web conf&eacute;rence n&acute;est pas possible puisque votre utilisateur Via est supprimé ou inactif.<br/>
